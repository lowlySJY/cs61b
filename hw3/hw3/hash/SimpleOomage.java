...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o.getClass() == this.getClass())) {
            ...
            if (o == this) {
                ...
                SimpleOomage oCopy = (SimpleOomage) o;
                return (this.red == oCopy.red) && (this.green == oCopy.green) && (this.blue == oCopy.blue);
            }
        }
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return red * 256 / 17 + green * 256 * 256 / 17 + blue * 256 * 256 *256 / 17;
        }
    }
